//
//  RollpeV1InfoViewController.swift
//  Roll-Pe
//
...
class RollpeV1InfoViewController: UIViewController {
    let pCode: String
...
struct RollpeV1InfoViewControllerPreview: PreviewProvider {
    static var previews: some View {
        UIViewControllerPreview {
            RollpeV1InfoViewController(pCode: "")
        }
    }
}
#endif
