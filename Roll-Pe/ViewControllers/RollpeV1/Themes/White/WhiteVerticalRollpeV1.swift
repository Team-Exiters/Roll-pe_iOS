...
class WhiteVerticalRollpeV1: UIControl {
    ...
    private let titleLabel: UILabel = {
        ...
        label.font = UIFont(name: "JalnanGothic", size: 40)
    ...
    private func setInfo(model: RollpeV1DataModel) {
        titleLabel.setTextWithLineHeight(text: model.title, lineHeight: 52)
